...
# def create_laplacian_image_pyramid_live(image, pyramid_levels):
#     vid_pyramid=[]    
...
#         if frame_number == 0:
#             vid_pyramid.append(
#                 numpy.zeros((image.shape[0], pyramid_sub_frame.shape[0], pyramid_sub_frame.shape[1], 3),
#                                 dtype="float"))
#         vid_pyramid[pyramid_level] = pyramid_sub_frame
#         return vid_pyramid
